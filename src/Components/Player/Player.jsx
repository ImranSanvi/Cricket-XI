...
const Player = ({player, availableBalance, setAvailableBalance,  purchasedPlayers, setPurchasedPlayers, count, setCount}) => {
    ...
    return (
        <div className='p-4 rounded-[10px] space-y-3  border border-green-300'>
            ...
            <h3><i className="fa-solid fa-person"></i><span className='font-semibold text-[20px]'>{player["player_name"]}</span></h3>
            <div className='flex justify-between items-center'>
                <p><i className="fa-solid fa-flag"></i><span className='font-normal text-[16px]'>{player["player_country"]}</span></p>
